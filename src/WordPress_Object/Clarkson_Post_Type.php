...
class Clarkson_Post_Type {
	...
	public function __get( string $name ): string {
		if ( property_exists( $this->post_type, $name ) ) {
	...
	public function get_title(): string {
		$title = $this->post_type->labels->singular_name;
		return $title;
	}
	...
	public function get_archive_title(): string {
		$title = apply_filters( 'post_type_archive_title', $this->post_type->labels->name, $this->post_type->name );
